...
void doGenotyping (ControlState & CurrentState, UserDefinedSettings* userSettings )
{
   ...
   for (unsigned SV_index =0; SV_index < AllSV4Genotyping.size(); SV_index++) {
      ...
      if (AllSV4Genotyping[SV_index].ChrA == AllSV4Genotyping[SV_index].ChrB && abs((int)(AllSV4Genotyping[SV_index].PosA - AllSV4Genotyping[SV_index].PosB)) < SV_Genotype_Cutoff) {
